...
static void gatts_profile_c_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param){
    ...
    case ESP_GATTS_REG_EVT:
        ESP_LOGI(GATTS_TAG, "REGISTER_APP_EVT, status %d, app_id %d\n", param->reg.status, param->reg.app_id);
        // Customize the battery service UUID
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        // Simulate battery level (you may want to implement actual battery level reading)
        uint8_t battery_level = 80; // Example: 80% battery level
    ...
    case ESP_GATTS_WRITE_EVT: {
        ...
        // Call a function to handle write events related to the battery service
        // example_write_event_env(gatts_if, &battery_prepare_write_env, param);
        break;
    }
    case ESP_GATTS_CREATE_EVT:
        // Handle the creation of the battery service
        // ...
        break;
    case ESP_GATTS_ADD_CHAR_EVT:
        // Handle the addition of characteristics for the battery service
        // ...
        break;
    // Add more cases as needed for your specific use case
    // ...
