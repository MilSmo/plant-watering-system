...
void relay_on(relay_t *relay) {
    gpio_set_level(relay->relay_pin, 1); // Ustawienie wysokiego poziomu na pinie włącza przekaźnik
}

void relay_off(relay_t *relay) {
    gpio_set_level(relay->relay_pin, 0); // Ustawienie niskiego poziomu na pinie wyłącza przekaźnik
}
