...
void http_get_page(const char *url) {
    esp_http_client_config_t config = {
        ...
        .cert_pem = NULL,  // Ścieżka do pliku PEM, jeśli jest wymagane
        .timeout_ms = 5000,  // Timeout w milisekundach
        .keep_alive_enable = true,  // Pozostaw połączenie aktywne między żądaniami
        .skip_cert_common_name_check = true,  // Pomiń sprawdzanie Common Name
        .user_data = NULL,  // Dostosowane dane użytkownika, jeśli są potrzebne
...
void app_main(void)
{
    ...
    // const char *url = "http://info.cern.ch";
        const char *url = "http://www.agh.edu.pl"; 
