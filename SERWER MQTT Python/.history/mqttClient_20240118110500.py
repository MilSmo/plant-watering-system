...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("/ESP_ID/moisture")
    client.subscribe("/ESP_ID/pump")
    client.subscribe("/ESP_ID/stop_moisture")
    ...
    while True:
        ...
        if value == '1' or value == '0':
            ...
            if should_read_moisture:
                ...
                client.publish("/topic/stop_moisture", "0")
            else:
                print("Moisture reading stopped.")
                client.publish("/topic/stop_moisture", "1")
        elif value == '4':
            print_database()
        else:
